...
const page = () => {
  return (
    <>
          ...
          <div className="py-4 px-6 bg-black-1100/40 backdrop-blur-[2.5px] rounded-2xl max-w-113.25 w-full mx-auto">
            <ol>
              <li className="flex items-center gap-4">
                ...
                <p className="md:text-base text-sm font-normal leading-4.25 md:leading-5.5 text-left flex-1 text-white-1100">
        ...
        <div className="max-w-338 w-full mx-auto md:px-10 px-4 xl:px-4">
          <div className="flex items-center md:flex-row flex-col lg:gap-10 xl:gap-15">
            <div className="md:w-[40%] w-full md:pb-0 pb-8">
              <h2 className="xl:text-5xl md:text-[32px] text-[28px] leading-8.5 md:leading-11 font-bold xl:leading-16.75 text-white-1100 pb-3">
          ...
          <div className="flex items-end md:flex-row flex-col-reverse lg:items-start lg:gap-17.75 relative z-1 rounded-2xl bg-black-1100 pt-10.75 md:pt-22.75 pr-6 xl:pr-12 shadow-4xl">
            <div className="lg:w-2/5 md:w-1/3 w-full relative z-1">
              <img
                ...
                alt=""
                className="xl:h-128 lg:h-79.5 h-71 object-cover"
              />
            </div>
              ...
              <ol className="flex flex-col items-right">
                <li className="md:pb-6 pb-4">
                  <div className="flex items-center justify-end">
                    <p className="xl:text-2xl text-xl leading-7 font-semibold xl:leading-8.25 text-white-1100">
      ...
      <section className="bg-linear-to-r from-yellow-1200 via-orange-1100 to-yellow-1200 py-12 md:py-14 xl:py-22">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="text-center border-b border-solid border-white-1100/40 pb-8 md:pb-10 mb-8 md:mb-14 xl:mb-16 relative">
            ...
            <span className="w-191.5 h-37.5 xl:hidden flex items-center justify-center rounded-[100%] bg-linear-to-r from-yellow13 from-0% to-white to-100% absolute -top-20 left-1/2  -translate-x-1/2 -z-1 blur-[150px] opacity-50"></span>
          </div>
      ...
      <section className="md:pt-66.25 pt-22 pb-[98px] md:pb-83.5 bg-[url(/images/missionbg.jpg)] bg-no-repeat bg-cover overflow-hidden">
      ...
      <section className="xl:py-45 md:py-30 py-20 relative">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full relative z-1">
          <div className="text-center border-b border-solid border-white-1100/40 pb-8 relative">
            ...
            <h2 className="xl:text-5xl md:text-[32px] text-xl text-white-1100 font-bold md:leading-11 xl:leading-16.75 leading-8 pb-8">
          ...
          <div className="flex xl:items-center md:flex-row flex-col gap-6 xl:gap-8 pt-8 md:pt-16">
            <div className="md:w-1/2 w-full">
              <h3 className="xl:text-[32px] text-lg leading-[22px] md:text-2xl md:leading-7.25 font-medium xl:leading-10 text-white-1100 pb-6">
      ...
      <section className="xl:pb-45 md:pb-30 pb-20">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full relative z-40">
          ...
          <div className="xl:mt-16 md:mt-14 mt-8 grid md:grid-cols-2 gap-6 xl:gap-8">
            <div className="group cursor-pointer relative transition-all duration-500 ease-in-out rounded-2xl bg-black-1100 shadow-4xl overflow-hidden">
              <div className="group-hover:-translate-x-full transition-all duration-500 ease-in-out flex flex-col rounded-2xl relative">
                ...
                <div className="absolute top-0 left-0 px-6 xl:px-10 py-8 xl:py-12">
                  <h3 className="text-white-1100 font-medium text-xl leading-7 xl:text-[32px] xl:leading-[124%]">
      ...
      <section className="xl:pb-45 md:pb-30 pb-20">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          ...
          <div className="flex items-center md:flex-row flex-col gap-5 justify-between pt-14 xl:pt-16 pb-10 xl:pb-12">
      ...
      <section>
        <div className="max-w-308 mx-auto w-full md:px-10 px-4 xl:px-4 relative z-40">
          <div className="text-center border-b border-solid border-white-1100/40 pb-8 xl:pb-10 relative">
            <span className="md:w-191.5 w-full h-37.5 flex items-center justify-center rounded-[100%] bg-linear-to-r from-yellow13 from-0% to-white to-100% absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-1 blur-[150px] opacity-50"></span>
            <h2 className="text-white font-bold md:text-5xl text-xl leading-6 md:leading-11 xl:leading-[140%]">
      ...
      <section className="overflow-hidden xl:py-45 md:py-30 py-20">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full ">
          <div className="text-center border-b border-solid border-white-1100/40 md:pb-10 pb-8 relative">
            <span className="md:w-191.5 w-full h-37.5 flex items-center justify-center rounded-[100%] bg-linear-to-r from-yellow13 from-0% to-white to-100% absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-1 blur-[150px] opacity-50"></span>
            <h2 className="md:text-5xl text-base text-white-1100 font-bold md:leading-11 xl:leading-16.75 leading-[19px] md:leading-8">
      ...
      <section className="xl:pb-45 md:pb-30 pb-20">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="text-center border-b border-solid border-white-1100/40 pb-10 relative">
            <span className="md:w-191.5 w-full h-37.5 flex items-center justify-center rounded-[100%] bg-linear-to-r from-yellow13 from-0% to-white to-100% absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-1 blur-[150px] opacity-50"></span>
            <h2 className="md:text-5xl text-xl leading-6 md:leading-11 font-bold xl:leading-16.75 text-white-1100 pb-6">
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-6 xl:gap-8 py-8 md:py-14 xl:py-16 xl:max-w-full max-w-166 mx-auto xl:w-auto w-full">
            <div className="bg-[url(/images/border.png)] bg-no-repeat group bg-size-[100%_100%] xl:bg-cover hover:bg-none border-solid border-transparent border hover:border-white-1100 rounded-2xl min-h-auto xl:min-h-46.75 2xl:min-h-47.75">
              <div className="bg-[url(/images/agentur-img1.png)] group-hover:bg-[url(/images/statbg.png)] h-full bg-no-repeat bg-size-[100%_100%] xl:bg-cover rounded-2xl 2xl:p-8 xl:p-6 px-2.5 py-4 md:p-8">
                <h3 className="text-gradient text-[28px] md:text-[40px] xl:text-5xl font-semibold uppercase leading-[34px] md:leading-12.25 xl:leading-14.75 pb-3 md:pb-4">
                  +312%
                </h3>
          ...
          <div className="grid xl:grid-cols-2 gap-6 xl:gap-8 mb-8">
            <div className="border border-solid bg-[url(/images/info-bg.png)] bg-no-repeat bg-cover border-white-1100 rounded-2xl xl:py-4 py-5 px-4 md:p-6 xl:px-6 bg-linear-to-r from-cyan-500 to-blue-500">
              <div className="flex items-center gap-4 mb-4 xl:min-h-16.5">
                <span>
                  <img src="images/check.svg" alt="" />
                </span>
                <h4 className="md:text-2xl text-base text-white-1100 font-semibold leading-[19px] md:leading-8.25 flex-1">
                  Jahrelange Online Marketing <br className="xl:block hidden" />{" "}
                  Erfahrung
                </h4>
              </div>
              <p className="md:text-base text-sm font-normal leading-[17px] md:leading-5.5 text-white-1100">
            ...
            <div className="border border-solid bg-[url(/images/info-bg.png)] bg-no-repeat bg-cover border-white-1100 rounded-2xl md:py-4 py-5 px-4 md:px-6 bg-linear-to-r from-cyan-500 to-blue-500">
      ...
      <section className="bg-linear-to-r from-yellow-1200 via-orange-1100 to-yellow-1200 py-10 relative z-1">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="text-center border-b border-solid border-white-1100/40 pb-8 xl:pb-10">
            <h2 className="md:text-[32px] font-medium text-white-1100 text-base leading-[19px] md:leading-9.75">
      ...
      <section className="overflow-hidden py-20 md:py-30 xl:pb-45">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full ">
          <div className="text-center border-b border-solid border-white-1100/40 pb-10 relative">
            ...
            <span className="w-191.5 h-37.5 xl:hidden flex items-center justify-center rounded-[100%] bg-linear-to-r from-yellow13 from-0% to-white to-100% absolute top-0 left-1/2 -translate-x-1/2 blur-[150px] opacity-50"></span>
          </div>
        </div>
      ...
      <section className="relative">
        <div className="relative z-3 bg-[url(/images/securebg.png)] bg-no-repeat bg-cover py-11">
          ...
          <img
            ...
            alt=""
            className="absolute md:-top-8.5 top-auto md:bottom-auto bottom-0 xl:h-auto h-[285px] md:h-118.75 xl:-top-39.25 right-0 z-1"
          />
        </div>
      ...
      <section className="xl:pt-45 md:pt-30 pt-20">
        <div className="max-w-300 mx-auto w-full px-4 md:px-10 xl:px-4">
          <div className="text-center pb-14 xl:pb-16.75 relative">
            <h2 className="text-orange-1100 xl:text-5xl font-bold md:text-[32px] text-xl md:leading-11 xl:leading-16.75 leading-6 md:leading-8 pb-2 xl:pb-3">
            ...
            <p className="md:text-base text-sm text-white-1100 font-normal leading-[17px] md:leading-5.5 pb-8 xl:pb-6">
          ...
          <div className="sticky top-0 rounded-2xl bg-black-1200 py-8 min-h-[524px] px-6 xl:p-8 shadow-4xl mb-11.75">
            <h4 className="xl:text-2xl md:text-xl text-base font-semibold text-white-1100 leading-[19px] md:leading-7 xl:leading-8.25 pb-6 xl:pb-8">
          ...
          <div className="sticky top-0 rounded-2xl bg-[url(/images/listboxbg.png)] min-h-[524px] bg-cover bg-no-repeat  py-8 px-6 xl:p-8 shadow-4xl mb-11.75">
            <h4 className="xl:text-2xl md:text-xl text-base font-semibold text-white-1100 leading-[19px] md:leading-7 xl:leading-8.25 pb-6 xl:pb-8">
          ...
          <div className="sticky top-0 rounded-2xl bg-black-1200 min-h-[524px] p-8 shadow-4xl mb-11.75">
            <h4 className="xl:text-2xl md:text-xl text-base font-semibold text-white-1100 leading-[19px] md:leading-7 xl:leading-8.25 pb-6 xl:pb-8">
          ...
          <div className="sticky top-0 rounded-2xl bg-black-1200  min-h-[524px] py-8 px-6 xl:p-8 shadow-4xl">
            <h4 className="xl:text-2xl md:text-xl text-base font-semibold text-white-1100 leading-[19px] md:leading-7 xl:leading-8.25 pb-6 xl:pb-8">
      ...
      <section className="xl:pt-45 md:pt-30 pt-20">
        <div className="max-w-308  md:px-10 px-4 xl:px-4 mx-auto w-full">
          <div className="text-center relative border-b border-solid border-white/50 pb-10 mb-14 xl:mb-16">
            <h2 className="text-orange-1100 md:text-5xl leading-6 text-xl md:text-2xl font-bold md:leading-11 xl:leading-16.75 md:leading-8 pb-1 md:pb-3">
              Online Marketing Agentur:
            </h2>
            <span className="md:w-191.5 w-full h-37.5 flex items-center justify-center rounded-[100%] bg-linear-to-r from-yellow13 from-0% to-white to-100% absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -z-1 blur-[150px] opacity-50"></span>
            <h3 className="xl:text-[32px] md:text-xl text-base font-medium leading-[19px] text-white-1100 md:leading-7 xl:leading-9.75 pb-4 md:pb-6">
      ...
      <section className="xl:pt-45 md:pt-30 pt-20 bg-[url(/images/marketingbg.jpg)] bg-no-repeat bg-cover">
        <div className="max-w-308 pb-[168px] md:pb-68.5 xl:pb-97 md:px-10 px-4 xl:px-4 mx-auto w-full relative">
          <div className="text-center relative border-b border-solid border-white/50 pb-10 mb-8 md:mb-14 xl:mb-16">
            <h2 className="text-orange-1100 md:text-[32px] xl:text-5xl font-bold md:leading-11 xl:leading-16.75 text-xl leading-6 md:leading-8 pb-3">
              Online Marketing Agentur:
            </h2>
          ...
          <div className="max-w-291 w-full mx-auto">
            <h3 className="xl:pb-16 pb-8 md:pb-12 xl:text-2xl text-base md:text-xl font-semibold leading-[19px] md:leading-7 text-white-1100 xl:leading-8.25">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-white-1100 font-normal leading-4.25">
                    ...
                    Schlüssel, um die Relevanz deiner Botschaften zu steigern.
                    Deine Online Marketing Agentur setzt auf moderne
                    Marketing-Automatisierung, um personalisierte Inhalte zur
                    richtigen Zeit an die richtige Zielgruppe zu liefern. Mit
                    dieser Strategie kannst du sicherstellen, dass deine Kunden
                    sich individuell angesprochen fühlen, was das Engagement
                    deutlich erhöht.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-white-1100 font-normal leading-4.25">
                    ...
                    Trend, sondern eine effektive Methode, um die Kundenbindung
                    zu stärken und deine Conversion-Raten zu steigern. Deine
                    Marketing-Agentur hilft dir, relevante Inhalte zu erstellen,
                    die auf den individuellen Bedürfnissen deiner Zielgruppe
                    basieren. Dadurch fühlen sich deine Kunden stärker mit
                    deiner Marke verbunden, was zu langfristigem Erfolg führt
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h5 className="text-sm font-semibold leading-4.75 text-orange-1100 pb-4">
                    Techniken zur Segmentierung deiner Zielgruppe durch deine
                    Online Marketing Agentur
                  </h5>
                  <p className="text-sm text-white-1100 font-normal leading-4.25">
                    Eine gezielte Segmentierung der Zielgruppe ist entscheidend
                    für den Erfolg personalisierter Kampagnen. Deine Online
                    Marketing Agentur nutzt fortschrittliche Analysetools, um
                    deine Zielgruppe nach demografischen Daten, Kaufverhalten
                    und Interessen zu segmentieren. Dies ermöglicht es dir,
                    maßgeschneiderte Inhalte zu erstellen, die exakt auf die
                    Bedürfnisse der verschiedenen Segmente abgestimmt sind.
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-white-1100 font-normal leading-4.25">
                    ...
                    Marketing-Agentur entwickelt eine umfassende Strategie, die
                    von dynamischen Inhalten bis hin zu individualisierten
                    Produktempfehlungen reicht. So erzielst du eine höhere
                    Relevanz und bessere Ergebnisse in allen Bereichen deines
                    Marketings.
                  </p>
                </div>
              </div>
          ...
          <img
            ...
            alt=""
            className="absolute -bottom-20 md:-bottom-27.5 right-10 lg:right-30 xl:h-auto h-[229px] md:h-88"
          />
        </div>
      </section>
    </>
