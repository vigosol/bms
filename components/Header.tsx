    ...
    <>
                    ...
                    <DropdownMenu>
                      ...
                      >
                        {LEISTUNGEN_LINKS.map(({ label, href }, i) => (
                          <DropdownMenuItem
                            key={label}
                            className={`p-0 ${i < LEISTUNGEN_LINKS.length - 1 ? "mb-6" : ""}`}
                          >
                            <Link
                              href={href}
      ...
      <div
        className={`
          ...
          ${drawerOpen ? "opacity-80 pointer-events-auto" : "opacity-0 pointer-events-none"}
        `}
        ...
        <div>
          ...
          >
            ...
            <img
              ...
              alt=""
              className={`transition-transform duration-200 ${regionalOpen ? "rotate-180" : "rotate-0"}`}
            />
          </button>
